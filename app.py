...
if __name__ == '__main__':
    # Render akan memberikan nomor port melalui environment variable 'PORT'
    # Jika tidak ada (saat dijalankan di lokal), kita gunakan 5000
    port = int(os.environ.get('PORT', 5000))

    with app.app_context():
        db.create_all() 
    # Jalankan aplikasi menggunakan port dari Render
